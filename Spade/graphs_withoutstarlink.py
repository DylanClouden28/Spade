...
def generateDensityBins(db: USCDatabaseHelper):
    result = db.cursor.execute(
        ...
        WHERE
            ...
            AND SATELLITE_NAME NOT LIKE '%STARLINK%'
        """
    )
    ...
    filename = "./rendered_graphs/DensityLineGraph_nostarlink.png"
...
def generateAltInc(db: USCDatabaseHelper):
    ...
    filename = "./rendered_graphs/ScatterALtInc_nostarlink.png"
    plt.savefig(filename)
...
def generateScatterAVG(db: USCDatabaseHelper):
    ...
    filename = "./rendered_graphs/ScatterPlotAVG_nostarlink.png"
    plt.savefig(filename)
    print("saved file for scatter plot: ", filename)
...
def generateScatterPlots(db: USCDatabaseHelper):
    ...
    filename = "./rendered_graphs/ScatterPlot_nostarlink.png"
    plt.savefig(filename)
    print("saved file for scatter plot: ", filename)
...
def generateSatellitesOvertime(db: USCDatabaseHelper):
    ...
    filename = "./rendered_graphs/Cumulative_Objects_in_Orbit_by_Type_nostarlink.png"
    plt.savefig(filename)
